...
# Installation
For now Cyclones is hosted only GitHub and the most current stable version can be installed via the steps below. A development version is also available but may be unstable as new issues are addressed.
